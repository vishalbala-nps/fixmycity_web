...
// ✅ Import the new VoiceToText component
...
const ReportIssueModal = ({ open, onClose, currentLocation, onIssueSubmitted }) => {
  ...
  // ✅ Handler to append voice notes
  const handleVoiceResult = (text) => {
    setDescription((prev) => prev + '\n' + `[User added via voice note]: ${text}`);
  };
  ...
  <Box sx={modalStyle}>
        ...
        {loading && (
          ...
          >
            <CircularProgress />
            <Typography mt={1}>Processing image...</Typography>
          </Box>
        )}
        ...
        {!loading && (
          <>
            {isDuplicate ? (
              // Duplicate issue detected view (unchanged) ...
              <Box mb={2}>
                <Typography
                  color="warning.main"
                  align="center"
                ...
                <Typography
                  ...
                  mb={2}
                >
                  This issue may have already been reported. Please review the
                  details below:
                </Typography>
                <Box
                  display="flex"
                ...
                >
                  ...
                  <Typography fontSize={17} mb={1} color="text.primary">
                    {category}
                  </Typography>
                  <Typography
                    variant="h6"
              ...
              <>
                ...
                <Box mb={1.5} display="flex" gap={2}>
                  ...
                  <FormControl fullWidth disabled={!fieldsEditable}>
                    ...
                    >
                      <MenuItem value="Department of Drinking Water and Sanitation">
                        Department of Drinking Water and Sanitation
                      </MenuItem>
                      <MenuItem value="Department of Rural Works">
                        Department of Rural Works
                      </MenuItem>
                      <MenuItem value="Department of Road Construction">
                        Department of Road Construction
                      </MenuItem>
                      <MenuItem value="Department of Energy">Department of Energy</MenuItem>
                      <MenuItem value="Department of Health, Medical Education & Family Welfare">
